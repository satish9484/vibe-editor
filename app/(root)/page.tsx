  ...
  return (
    <div className=' z-20 flex flex-col items-center justify-start min-h-screen py-2 mt-10'>
      <div className='flex flex-col justify-center items-center my-5'>
        <Image src={'/hero.svg'} alt='Hero-Section' height={500} width={500} style={{ width: 'auto', height: 'auto' }} priority />
      ...
      <p className='mt-2 text-lg text-center text-gray-600 dark:text-gray-400 px-5 py-10 max-w-2xl'>
        VibeCode Editor is a powerful and intelligent code editor that enhances your coding experience with advanced features and seamless
        integration. It is designed to help you write, debug, and optimize your code efficiently.
      </p>
      <Link href={'/dashboard'}>
