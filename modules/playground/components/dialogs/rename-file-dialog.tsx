        ...
        <form onSubmit={handleSubmit}>
          <div className='grid gap-4 py-4'>
            <div className='grid grid-cols-3 items-center gap-4'>
              ...
              <Input id='rename-filename' value={filename} onChange={e => setFilename(e.target.value)} className='col-span-2' autoFocus />
            </div>
            <div className='grid grid-cols-3 items-center gap-4'>
              <Label htmlFor='rename-extension' className='text-right'>
                Extension
              </Label>
              <Input id='rename-extension' value={extension} onChange={e => setExtension(e.target.value)} className='col-span-2' />
            </div>
          </div>
          <DialogFooter>
