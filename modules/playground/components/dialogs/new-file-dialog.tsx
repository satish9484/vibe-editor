        ...
        <form onSubmit={handleSubmit}>
          <div className='grid gap-4 py-4'>
            <div className='grid grid-cols-3 items-center gap-4'>
              ...
              <Input id='filename' value={filename} onChange={e => setFilename(e.target.value)} className='col-span-2' autoFocus placeholder='main' />
            </div>
            <div className='grid grid-cols-3 items-center gap-4'>
              <Label htmlFor='extension' className='text-right'>
                Extension
              </Label>
              <Input id='extension' value={extension} onChange={e => setExtension(e.target.value)} className='col-span-2' placeholder='js' />
            </div>
          </div>
          <DialogFooter>
