...
export default function ProjectTable({ projects, onUpdateProject, onDeleteProject, onDuplicateProject }: ProjectTableProps) {
          ...
          <TableBody>
            {projects.map(project => (
              <TableRow key={project.id}>
                ...
                <TableCell>
                  <span className='text-sm text-gray-500'>{format(new Date(project.createdAt), 'MMM dd, yyyy')}</span>
                </TableCell>
                <TableCell>
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
        <DialogContent className='sm:max-w-[425px]'>
          <DialogHeader>
            ...
            <DialogDescription>Make changes to your project details here. Click save when you're done.</DialogDescription>
          </DialogHeader>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete "{selectedProject?.title}"? This action cannot be undone. All files and data associated with this
