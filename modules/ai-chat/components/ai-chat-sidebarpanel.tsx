...
import { Brain, Code, Copy, Download, Filter, Loader2, MessageSquare, RefreshCw, Search, Send, Settings, Sparkles, User, X, Zap } from 'lucide-react';
          ...
          <div className='shrink-0 border-b border-zinc-800 bg-zinc-900/80 backdrop-blur-sm'>
            <div className='flex items-center justify-between p-6'>
              <div className='flex items-center gap-3'>
                ...
                <div>
                  <h2 className='text-lg font-semibold text-zinc-100'>Enhanced AI Assistant</h2>
              ...
              <div className='flex items-center gap-2'>
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align='end'>
                    ...
                    <DropdownMenuCheckboxItem checked={streamResponse} onCheckedChange={setStreamResponse}>
                      Stream responses
                    </DropdownMenuCheckboxItem>
                    <DropdownMenuSeparator />
                    ...
                    <DropdownMenuItem onClick={() => setMessages([])}>Clear All Messages</DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>

                <Button variant='ghost' size='sm' onClick={onClose} className='h-8 w-8 p-0 text-zinc-400 hover:text-zinc-100 hover:bg-zinc-800'>
                  <X className='h-4 w-4' />
                </Button>
              </div>
            </div>
            ...
            {/* Enhanced Controls */}
            <Tabs value={chatMode} onValueChange={value => setChatMode(value as any)} className='px-6'>
            ...
            <div className='p-6 space-y-6'>
              {filteredMessages.length === 0 && !isLoading && (
                <div className='text-center text-zinc-500 py-16'>
                  ...
                  <h3 className='text-xl font-semibold mb-3 text-zinc-300'>Enhanced AI Assistant</h3>
            ...
            <div className='flex items-end gap-3'>
              <div className='flex-1 relative'>
                ...
                <div className='absolute right-3 bottom-3 flex items-center gap-2'>
                  <kbd className='hidden sm:inline-block px-1.5 py-0.5 text-xs text-zinc-500 bg-zinc-800 border border-zinc-700 rounded'>⌘↵</kbd>
                </div>
              </div>
              <Button
                type='submit'
